...
Le fait est qu'il faut voir D&D comme un JDR fait par un wargamer (Gary Gygax) et pour des joueurs à l'esprit wargamer.
...
- Une volonté de retourner à des règles plus simples (comme D&D 0e ou 1e), ouvrant la possibilité à des règles customisées par les MJ ;
- Un appétit pour les scénarios simples d'exploration de "donjons" à l'ancienne ;
