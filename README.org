...
* Dernières livraisons PDF

#+ATTR_HTML: :border 2 :rules all :frame border
| Date | JDR-RPG          | Type             | Livrable                        | Commentaire                                         |
|------+------------------+------------------+---------------------------------+-----------------------------------------------------|
| 2021 | DungeonSquad! VF | JDR pour enfants | [[https://github.com/orey/jdr/blob/master/DungeonSquad-fr/DungeonSquad-VersionFrancaise-OreyJdr01.pdf][DungeonSquad! Version Française PDF]] | Traduction originale                                |
