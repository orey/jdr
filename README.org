...
- [[#Syst%C3%A8mes-de-jeux][Systèmes de jeux]]
    - [[#a-propos-des-jdr-modernes][A propos des JDR modernes]]
...
- Il faut une certaine expérience du JDR pour pouvoir définir des mots utiles au jeu ; en un sens, le JDR s'adresse implicitement à des vétérans, voire à des vétérans dans un mode jeu ironique (voire cynique) ; ou à des débutants qui n'ont pas de point de comparaison.
...
Beaucoup de jeux plus récents établissent une vraie dictature du background en le structurant de manière schématique (voire caricaturale) en termes de jeu. Ainsi, on voit apparaître, en plus de la notion de "cliché" ou d'"archétype"  :

- Une certaine obsession pour les défauts des personnages, souvent utiles pour gagner des points dans le processus de création, parfois obligatoires dans le processus, souvent en pendant de dons ;
- Des contacts sociaux obligatoires,
- Un ennemi juré obligatoire,
- Etc.

Cette schématisation à outrance du background des personnages concourt à en faire des caricatures issues du même moule, et à rendre suffocant l'univers des personnages. Dans une conception ancienne, le PJ doit être libre avant tout et n'a pas à être "backgroundisé" arbitrairement au travers de dimensions caricaturales.
...
Or, jouer des caricatures ou des archétypes de personnages de films ou de BD est très limité et, pour moi, assez loin de la notion de jeu de rôle. Il y a un côté stressant à cette approche. En fait, c'est comme si les jeux de super-héros avaient gagné en esprit sur le reste du JDR : il semble qu'il faille jouer des caricatures standardisées dans les jeux modernes.

*** Les "move" ou un degré de plus vers le jeu de plateau

Dans certains jeux relativement récents, les mots sont devenus les "move". Le game designer impose, en plus de tout ce que nous avons vu, une certaine manière de jouer en déterminant les "move" par type de personnage ou pour tous les types. Généralement, ces moves sont spécifiques au jeu, peu faciles à comprendre et à utiliser, et en recouvrement sémantique les uns avec les autres.

Pour moi, nous entrons là dans le jeu de plateau. Si mon personnage caricatural n'a droit qu'à un certain nombre de moves au cours du jeu (ou disons que seuls les moves du designer font progresser l'aventure), alors oui, nous sommes dans une forme de jeu de plateau sans plateau. D'un autre côté, il semble que la logique de la caricature ait été poussée à son extrême : un jeu de caricatures menant des aventures avec des moves standardisés.

Je ne parle pas des modes de résolution de certains jeux qui sont, pour le moins, expéditifs. Parce que les modificateurs de difficulté sont "mauvais", alors les joueurs ne peuvent plus mesurer les risques qu'ils prennent... 
...
Je ne suis pas certain que les bons game designers soient plus nombreux aujourd'hui qu'hier, malgré le fait que Itch ou Kickstarter permette à de mauvais game designers de pousser leurs produits.
