...
\section{Liens}
\label{sec:orgf2dfedb}

\subsection{Sites de jeux en français}
\label{sec:org4f0857c}
...
\subsubsection{Le Graal}
\label{sec:orgd648b23}

Le Graal serait pour moi un jeu de rôle classique avec un peu de mécanique mais pas trop, mais pouvant être pris en mains rapidement dans tous les univers\ldots{} Ahaha, oui, c'est impossible.
...
\subsection{Numéro 1 - Basic Roleplaying System - BRS}
\label{sec:orgf8d6bec}

Le système Basic RPS (\href{https://www.chaosium.com/brp-system-reference-document/}{SRD ici}) est un système très adaptable, logique et sans déformation de probabilités (contrairement au \href{https://github.com/orey/jdr/tree/master/D6-System}{système D6}). Il est particulièrement bien adapté aux univers historiques et contemporains.

\subsection{Numéro 2 - Maléfices}
\label{sec:orgd8ce39c}

\begin{itemize}
\item Un système de jeu très adapté à l'univers.
\item Tarot très utile dans le jeu.
\end{itemize}

\subsection{Numéro 3 - Donjons et Dragons}
\label{sec:orgef6c1fb}
...
\label{sec:orgba35041}

\subsubsection{Fudge}
\label{sec:org8d4a72a}
...
\item Le second est la gestion des échelles, qui est une vraie originalité de Fudge. Il est, en effet, possible de faire lutter des PJ et PNJ appartenant à des échelles différents. Une innovation très intéressante.
\end{itemize}

Voir l'\href{https://github.com/orey/jdr/tree/master/Fudge-fr}{article détaillé}.

\subsubsection{Tunnels \& Trolls}
\label{sec:org3a1726d}
...
\label{sec:org78ae2ac}

\begin{enumerate}
\item Mécanisme de combat
\label{sec:org891e9b7}
